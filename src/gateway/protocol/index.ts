...
export const validateAgentsCreateParams = ajv.compile<AgentsCreateParams>(
  AgentsCreateParamsSchema,
);
export const validateAgentsUpdateParams = ajv.compile<AgentsUpdateParams>(
  AgentsUpdateParamsSchema,
);
export const validateAgentsDeleteParams = ajv.compile<AgentsDeleteParams>(
  AgentsDeleteParamsSchema,
);
...
export const validateNodeEventParams = ajv.compile<NodeEventParams>(
  NodeEventParamsSchema,
);
export const validatePushTestParams =
  ajv.compile<PushTestParams>(PushTestParamsSchema);
...
export const validateSessionsUsageParams = ajv.compile<SessionsUsageParams>(
  SessionsUsageParamsSchema,
);
...
export const validateConfigPatchParams = ajv.compile<ConfigPatchParams>(
  ConfigPatchParamsSchema,
);
...
export const validateTalkConfigParams = ajv.compile<TalkConfigParams>(
  TalkConfigParamsSchema,
);
...
export const validateToolsCatalogParams = ajv.compile<ToolsCatalogParams>(
  ToolsCatalogParamsSchema,
);
export const validateSkillsBinsParams = ajv.compile<SkillsBinsParams>(
  SkillsBinsParamsSchema,
);
...
export const validateWebLoginPairPhoneParams =
  ajv.compile<WebLoginPairPhoneParams>(WebLoginPairPhoneParamsSchema);
